...
plt.savefig(os.path.join(OUTPUT_DIR, 'Figure_2.png'), format='png', dpi=300, bbox_inches='tight')

print(f"Export successful! Figure saved to {OUTPUT_DIR}: Figure_2.png")