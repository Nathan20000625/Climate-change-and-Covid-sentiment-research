...
# 4. Adjust layout and export high-resolution images (PNG format to specified folder)
plt.tight_layout(pad=3.0)
output_dir = data_dir
os.makedirs(output_dir, exist_ok=True)

# 4.1 Export full Figure 1
output_png_path = os.path.join(output_dir, "Figure_1.png")
plt.savefig(output_png_path, format='png', dpi=300, bbox_inches='tight')  # 300 dpi bitmap
...
fig_a.savefig(os.path.join(output_dir, "Figure_1a.png"), format='png', dpi=300, bbox_inches='tight')
plt.close(fig_a)
...
fig_b.savefig(os.path.join(output_dir, "Figure_1b.png"), format='png', dpi=300, bbox_inches='tight')
plt.close(fig_b)
...
fig_c.savefig(os.path.join(output_dir, "Figure_1c.png"), format='png', dpi=300, bbox_inches='tight')
plt.close(fig_c)

print(f"Export successful! PNG image saved to: {output_png_path}, and 3 separate subplot PNG files.")