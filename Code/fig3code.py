...
# Input and output paths (resolved relative to this script)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
INPUT_FILE = os.path.join(BASE_DIR, 'fig3-data.csv')
OUTPUT_DIR = BASE_DIR
...
if not os.path.exists(INPUT_FILE):
    raise FileNotFoundError(
        ...
        f"Please place 'fig3-data.csv' in the same folder as this script."
    )
...
plt.savefig(
    os.path.join(OUTPUT_DIR, 'Figure_3.jpeg'),
    format='jpeg',
    dpi=300,
    bbox_inches='tight',
    facecolor='white',
...
print(f"Export successful! Figure saved to {OUTPUT_DIR}: Figure_3.jpeg")